...
The textbook contains **20 chapters** organized in a deliberate sequence. Each chapter builds on concepts from previous chapters, so students should work through them in order:

| Chapters | Topic Area |
|----------|-----------|
| 1–3 | Chemistry of Life (atomic structure, water, pH, organic chemistry, macromolecules) |
| 4–5 | Cell Structure and Function (organelles, membranes, transport) |
| 6–8 | Cellular Energetics (enzymes, photosynthesis, cellular respiration, fermentation) |
| 9–10 | Cell Communication and Cell Cycle (signaling, feedback, mitosis, cancer) |
| 11–12 | Heredity (meiosis, Mendelian genetics, non-Mendelian inheritance, chromosomal genetics) |
| 13–14 | Gene Expression and Regulation (central dogma, mutations, gene regulation, biotechnology) |
| 15–17 | Natural Selection and Evolution (evidence, population genetics, Hardy-Weinberg, speciation, phylogenetics) |
| 18–20 | Ecology (population ecology, community ecology, ecosystems, conservation) |
...
5. **Welcome from Gregor** — A mascot admonition that introduces the chapter topic in Gregor's friendly, scientifically curious voice.
6. **Main content** — The core instructional material, written at an advanced senior high / early college reading level. Includes tables, real-world examples, and embedded MicroSims.
7. **Mascot admonitions** — Throughout the chapter, Gregor appears 5–6 times to highlight key insights (thinking), offer practical tips (tip), provide encouragement on harder concepts (encourage), and warn about common mistakes (warning).
8. **Key takeaways** — A numbered summary of the most important concepts, preceded by a celebration from Gregor.
9. **Critical thinking challenge** — Expandable sections that train students to evaluate scientific claims and analyze experimental data.
...
The textbook includes over 86 MicroSims built with different visualization technologies:

| Technology | What It's Good For | Example MicroSims |
|-----------|-------------------|-------------------|
| **p5.js** | Interactive animations with sliders and buttons | Feedback Loop Simulator, Population Growth Model, Genetic Drift Simulator |
| **Chart.js** | Bar charts, line charts, pie charts | ATP Yield Calculator, Chi-Square Calculator |
| **vis-network** | Network diagrams showing connections | Learning Graph Viewer, Mendel-to-Meiosis Concept Map |
| **Diagram overlays** | Labeled biological structures with explore/quiz modes | Animal Cell, Neuron Structure, Cell Membrane, Chloroplast |
...
!!! mascot-tip "Gregor's Tip: Embed MicroSims Anywhere!"
    ...
    ```html
    <iframe src="https://dmccreary.github.io/biology/sims/YOUR-MICROSIM-NAME/main.html"
...
The **glossary** is an alphabetical list of all 378 key terms used in the textbook, each with a precise, concise definition. It serves as a quick-reference dictionary for students encountering unfamiliar vocabulary.
...
The **FAQ** (Frequently Asked Questions) is a curated list of common questions students ask about biology, organized by topic. Each question includes a clear, concise answer written at the same reading level as the chapters.

### How the FAQ is Organized

The FAQ covers questions across all 20 chapters. Questions are grouped by topic area to make browsing easy.
...
1. Go to the textbook's GitHub repository: [dmccreary/biology](https://github.com/dmccreary/biology)
...
1. Go to [dmccreary/biology](https://github.com/dmccreary/biology)
...
```bash
git clone https://github.com/dmccreary/biology.git
```
...
4. Open your browser to `http://127.0.0.1:8000/biology/` to see your customized version
...
This command builds the website and publishes it to `https://YOUR-USERNAME.github.io/biology/`. The process takes about 1–2 minutes.
...
For example, understanding the electron transport chain requires mastering cellular respiration basics, which requires understanding enzymes, which requires understanding protein structure. The learning graph makes these dependency chains visible.
...
## Gregor the Tree Frog: Your Pedagogical Agent
...
Gregor appears as colored callout boxes (called **admonitions**) throughout each chapter. There are seven types:
...
Gregor appears no more than 5–6 times per chapter to avoid overuse. Mascot admonitions are never placed back-to-back.

### Tips for Teachers

- **Read Gregor's tips aloud** — They're written in a conversational tone that works well when spoken
- **Use as discussion prompts** — Gregor's "thinking" admonitions highlight the most important insights in each chapter
- **Encourage struggling students** — Point students to Gregor's "encourage" admonitions when they're frustrated with a concept
