...
description: Interactive p5.js MicroSim for prokaryote vs. eukaryote cell comparison.
...
[Run the Prokaryote vs. Eukaryote Cell Comparison MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/biology/sims/prokaryote-eukaryote-comparison/main.html"
        height="450px"
        width="100%"
        scrolling="no"></iframe>
```
