...
description: Step-through interactive visualization revealing water molecule polarity — from bare geometry through partial charges, net dipole, and hydrogen bonds — with a detail panel explaining each layer.
image: /sims/water-molecule-polarity/water-molecule-polarity.png
og:image: /sims/water-molecule-polarity/water-molecule-polarity.png
twitter:image: /sims/water-molecule-polarity/water-molecule-polarity.png
social:
   cards: false
quality_score: 0
---
...
[Run the Water Molecule Polarity MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
...
1. [Water - Wikipedia](https://en.wikipedia.org/wiki/Water)
2. [Chemical polarity - Wikipedia](https://en.wikipedia.org/wiki/Chemical_polarity)
3. [Hydrogen bond - Wikipedia](https://en.wikipedia.org/wiki/Hydrogen_bond)
4. [VSEPR theory - Wikipedia](https://en.wikipedia.org/wiki/VSEPR_theory)
5. [Electronegativity - Wikipedia](https://en.wikipedia.org/wiki/Electronegativity)
