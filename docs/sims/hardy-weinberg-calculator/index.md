...
description: Interactive calculator where students input observed genotype counts (AA, Aa, aa), see allele frequencies (p, q), expected HWE genotype frequencies with bar chart comparison, and a chi-square goodness-of-fit test determining if the population is in equilibrium.
image: /sims/hardy-weinberg-calculator/hardy-weinberg-calculator.png
og:image: /sims/hardy-weinberg-calculator/hardy-weinberg-calculator.png
twitter:image: /sims/hardy-weinberg-calculator/hardy-weinberg-calculator.png
social:
   cards: false
quality_score: 0
---
...
[View Hardy-Weinberg Calculator Fullscreen](./main.html){ .md-button .md-button--primary }
...
1. [Hardy-Weinberg principle - Wikipedia](https://en.wikipedia.org/wiki/Hardy%E2%80%93Weinberg_principle)
2. [Chi-squared test - Wikipedia](https://en.wikipedia.org/wiki/Chi-squared_test)
3. [Allele frequency - Wikipedia](https://en.wikipedia.org/wiki/Allele_frequency)
