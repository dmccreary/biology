...
description: Interactive Chart.js MicroSim showing a 4x4 Punnett square and phenotype bar chart for dihybrid crosses with configurable parent genotypes.
image: /sims/dihybrid-cross/dihybrid-cross.png
og:image: /sims/dihybrid-cross/dihybrid-cross.png
twitter:image: /sims/dihybrid-cross/dihybrid-cross.png
social:
   cards: false
---
...
[Run the Dihybrid Cross Outcome Visualizer MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
...
1. [Mendel's Laws of Inheritance - Wikipedia](https://en.wikipedia.org/wiki/Mendelian_inheritance)
2. [Dihybrid Cross - Wikipedia](https://en.wikipedia.org/wiki/Dihybrid_cross)
