...
description: Step-through visualization of endosymbiotic theory showing the engulfment of aerobic bacteria (becoming mitochondria) and cyanobacteria (becoming chloroplasts), with evidence cards and double membrane highlighting at each stage.
image: /sims/endosymbiosis-model/endosymbiosis-model.png
og:image: /sims/endosymbiosis-model/endosymbiosis-model.png
twitter:image: /sims/endosymbiosis-model/endosymbiosis-model.png
social:
   cards: false
quality_score: 0
---
...
1. [Endosymbiotic theory - Wikipedia](https://en.wikipedia.org/wiki/Symbiogenesis)
2. [Mitochondrion - Wikipedia](https://en.wikipedia.org/wiki/Mitochondrion)
3. [Chloroplast - Wikipedia](https://en.wikipedia.org/wiki/Chloroplast)
