...
description: Drag-and-drop cladogram builder where students place species on a phylogenetic tree based on shared derived characters (synapomorphies) shown in a character matrix, with answer checking and hints.
image: /sims/cladogram-builder/cladogram-builder.png
og:image: /sims/cladogram-builder/cladogram-builder.png
twitter:image: /sims/cladogram-builder/cladogram-builder.png
social:
   cards: false
quality_score: 0
---
...
[View Interactive Cladogram Builder Fullscreen](./main.html){ .md-button .md-button--primary }
...
1. [Cladistics - Wikipedia](https://en.wikipedia.org/wiki/Cladistics)
2. [Phylogenetic tree - Wikipedia](https://en.wikipedia.org/wiki/Phylogenetic_tree)
3. [Synapomorphy - Wikipedia](https://en.wikipedia.org/wiki/Synapomorphy)
