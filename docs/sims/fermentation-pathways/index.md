...
description: Interactive step-through MicroSim comparing lactic acid and alcoholic fermentation pathways, showing glycolysis, NAD+ recycling, ATP yield, and organism examples.
image: /sims/fermentation-pathways/fermentation-pathways.png
og:image: /sims/fermentation-pathways/fermentation-pathways.png
twitter:image: /sims/fermentation-pathways/fermentation-pathways.png
social:
   cards: false
---
...
<iframe src="main.html" height="865" width="100%" scrolling="no"></iframe>

[Run the Fermentation Pathways Comparison MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
...
1. [Fermentation - Wikipedia](https://en.wikipedia.org/wiki/Fermentation)
2. [Lactic acid fermentation - Wikipedia](https://en.wikipedia.org/wiki/Lactic_acid_fermentation)
3. [Ethanol fermentation - Wikipedia](https://en.wikipedia.org/wiki/Ethanol_fermentation)
4. [Glycolysis - Wikipedia](https://en.wikipedia.org/wiki/Glycolysis)
5. [NAD+ - Wikipedia](https://en.wikipedia.org/wiki/Nicotinamide_adenine_dinucleotide)
