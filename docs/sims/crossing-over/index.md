...
description: Interactive step-through p5.js MicroSim showing how crossing over during prophase I generates recombinant chromatids with novel allele combinations.
image: /sims/crossing-over/crossing-over.png
og:image: /sims/crossing-over/crossing-over.png
twitter:image: /sims/crossing-over/crossing-over.png
social:
   cards: false
quality_score: 0
---
...
[Run the Crossing Over Visualization MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/biology/sims/crossing-over/main.html"
        height="502px"
        width="100%"
        scrolling="no"></iframe>
```
...
1. [Chromosomal crossover - Wikipedia](https://en.wikipedia.org/wiki/Chromosomal_crossover)
2. [Genetic recombination - Wikipedia](https://en.wikipedia.org/wiki/Genetic_recombination)
3. [Meiosis - Wikipedia](https://en.wikipedia.org/wiki/Meiosis)
