...
description: Interactive step-through comparison of normal meiosis, nondisjunction in meiosis I, and nondisjunction in meiosis II showing chromosome segregation errors and resulting gamete compositions.
image: /sims/nondisjunction/nondisjunction.png
og:image: /sims/nondisjunction/nondisjunction.png
twitter:image: /sims/nondisjunction/nondisjunction.png
social:
   cards: false
quality_score: 0
---
...
This step-through visualization compares three parallel columns showing the same
cell progressing through meiosis: normal meiosis (left), nondisjunction in
meiosis I (center), and nondisjunction in meiosis II (right). Students can
pinpoint exactly where each error occurs and trace the chromosomal consequences
through both divisions to the final gametes.
...
1. [Nondisjunction - Wikipedia](https://en.wikipedia.org/wiki/Nondisjunction)
2. [Aneuploidy - Wikipedia](https://en.wikipedia.org/wiki/Aneuploidy)
3. [Down syndrome - Wikipedia](https://en.wikipedia.org/wiki/Down_syndrome)
