...
description: Interactive p5.js MicroSim comparing the three photosynthetic carbon fixation strategies — C3, C4 (Kranz anatomy), and CAM (temporal separation) — with climate suitability sliders.
image: /sims/photosynthesis-strategies/photosynthesis-strategies.png
og:image: /sims/photosynthesis-strategies/photosynthesis-strategies.png
twitter:image: /sims/photosynthesis-strategies/photosynthesis-strategies.png
social:
   cards: false
---
...
<iframe src="main.html" height="385" width="100%" scrolling="no"></iframe>

[Run the Photosynthesis Strategies MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
...
1. [C3 carbon fixation - Wikipedia](https://en.wikipedia.org/wiki/C3_carbon_fixation)
2. [C4 carbon fixation - Wikipedia](https://en.wikipedia.org/wiki/C4_carbon_fixation)
3. [Crassulacean acid metabolism - Wikipedia](https://en.wikipedia.org/wiki/Crassulacean_acid_metabolism)
4. [Photorespiration - Wikipedia](https://en.wikipedia.org/wiki/Photorespiration)
5. [RuBisCO - Wikipedia](https://en.wikipedia.org/wiki/RuBisCO)
