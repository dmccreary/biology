...
description: Side-by-side step-through comparison of allopatric (geographic barrier) and sympatric (polyploidy/niche shift) speciation in 5 synchronized stages, with gene flow indicators and quiz mode asking students to predict gene flow at each step.
image: /sims/speciation-pathways/speciation-pathways.png
og:image: /sims/speciation-pathways/speciation-pathways.png
twitter:image: /sims/speciation-pathways/speciation-pathways.png
social:
   cards: false
quality_score: 0
---
...
[View Speciation Pathways Comparison Fullscreen](./main.html){ .md-button .md-button--primary }
...
1. [Allopatric speciation - Wikipedia](https://en.wikipedia.org/wiki/Allopatric_speciation)
2. [Sympatric speciation - Wikipedia](https://en.wikipedia.org/wiki/Sympatric_speciation)
3. [Speciation - Wikipedia](https://en.wikipedia.org/wiki/Speciation)
