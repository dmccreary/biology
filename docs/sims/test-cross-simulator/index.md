...
description: Interactive p5.js MicroSim where students perform test crosses to determine an unknown genotype by generating offspring and analyzing statistical patterns.
image: /sims/test-cross-simulator/test-cross-simulator.png
og:image: /sims/test-cross-simulator/test-cross-simulator.png
twitter:image: /sims/test-cross-simulator/test-cross-simulator.png
social:
   cards: false
---
...
<iframe src="main.html" height="362" width="100%" scrolling="no"></iframe>

[Run the Test Cross Simulator MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
...
1. [Test Cross - Wikipedia](https://en.wikipedia.org/wiki/Test_cross)
