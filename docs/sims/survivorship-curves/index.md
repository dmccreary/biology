...
description: Semi-log Chart.js visualization of Type I, II, and III survivorship curves with a drag-and-drop organism classification activity where students match 9 organisms to their correct curve type.
...
[View Survivorship Curves Comparator Fullscreen](./main.html){ .md-button .md-button--primary }
...
1. [Survivorship curve - Wikipedia](https://en.wikipedia.org/wiki/Survivorship_curve)
2. [Life table - Wikipedia](https://en.wikipedia.org/wiki/Life_table)
3. [r/K selection theory - Wikipedia](https://en.wikipedia.org/wiki/R/K_selection_theory)
