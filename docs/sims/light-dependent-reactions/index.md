...
description: Interactive step-through MicroSim showing electron flow through the Z-scheme of photosynthesis, from water splitting through PSII and PSI to NADPH and ATP production.
image: /sims/light-dependent-reactions/light-dependent-reactions.png
og:image: /sims/light-dependent-reactions/light-dependent-reactions.png
twitter:image: /sims/light-dependent-reactions/light-dependent-reactions.png
social:
   cards: false
---
...
<iframe src="main.html" height="475" width="100%" scrolling="no"></iframe>

[Run the Light-Dependent Reactions MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
...
1. [Light-dependent reactions - Wikipedia](https://en.wikipedia.org/wiki/Light-dependent_reactions)
2. [Photosystem II - Wikipedia](https://en.wikipedia.org/wiki/Photosystem_II)
3. [Photosystem I - Wikipedia](https://en.wikipedia.org/wiki/Photosystem_I)
4. [Chemiosmosis - Wikipedia](https://en.wikipedia.org/wiki/Chemiosmosis)
5. [Z scheme - Wikipedia](https://en.wikipedia.org/wiki/Z_scheme)
