...
description: Interactive p5.js MicroSim for cell junctions explorer.
...
[Run the Cell Junctions Explorer MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/biology/sims/cell-junctions-explorer/main.html"
        height="450px"
        width="100%"
        scrolling="no"></iframe>
```
