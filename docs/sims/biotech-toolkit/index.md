...
description: Interactive Mermaid workflow diagram comparing gene cloning and CRISPR gene editing pipelines, showing how biotechnology tools connect in experimental workflows.
image: /sims/biotech-toolkit/biotech-toolkit.png
og:image: /sims/biotech-toolkit/biotech-toolkit.png
twitter:image: /sims/biotech-toolkit/biotech-toolkit.png
social:
   cards: false
---
...
[Run the Biotechnology Toolkit Workflow MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
...
1. [Recombinant DNA - Wikipedia](https://en.wikipedia.org/wiki/Recombinant_DNA)
2. [CRISPR Gene Editing - Wikipedia](https://en.wikipedia.org/wiki/CRISPR_gene_editing)
3. [Polymerase Chain Reaction - Wikipedia](https://en.wikipedia.org/wiki/Polymerase_chain_reaction)
4. [Gel Electrophoresis - Wikipedia](https://en.wikipedia.org/wiki/Gel_electrophoresis)
5. [Restriction Enzyme - Wikipedia](https://en.wikipedia.org/wiki/Restriction_enzyme)
