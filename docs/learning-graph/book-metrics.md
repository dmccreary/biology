...
| 3 | MicroSims | 86 | Recommended | Interactive simulations in docs/sims/ |
| 4 | Stories | 2 | Optional | Graphic-novel narratives in docs/stories/ |
| 5 | Chapter Quizzes | 3 / 20 | Recommended | Chapters with a quiz.md (30 questions total) |
| 6 | Chapter References | 0 / 20 | Recommended | Chapters with references.md (0 references total) |
| 7 | Glossary Terms | 378 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 110 | Recommended | Questions in faq.md |
| 9 | Words | 218,915 | Required | Words across student-facing markdown |
...
| Equations | 979 | 715 | LaTeX expressions (inline and display) |
| Total Words | 218,915 | 90,077 | Words in markdown files |
| Links | 624 | 119 | Hyperlinks in markdown format |
| Equivalent Pages | 939 | 423 | Estimated pages (250 words/page + visuals) |
