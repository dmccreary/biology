/* Biotechnology Toolkit Workflow - Interactive Script
   Handles hover interactions for the info panel.
   IMPORTANT: nodeInfo must be defined in main.html BEFORE this script loads.
*/

const infoDisplay = document.getElementById('info-display');
const defaultContent = '<p class="info-placeholder">Hover over a node to learn about that biotechnology tool and its role in the workflow.</p>';
